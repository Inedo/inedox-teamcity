...
{
    internal sealed class BuildNumberHiddenField : HiddenField
    {
        public BuildNumberHiddenField()
        {
            this.Enabled = true;
        }
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            this.IncludeClientResourceInPage(
                new JavascriptResource("/extension-resources/TeamCity/Assets/Scripts/BuildNumberPicker.js", InedoLibCR.select2)
            );
        }
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            InedoLib.Util.JavaScript.WriteJson(
                ...
                new
                {
                    ajaxUrl = Ajax.GetUrl(new Func<string, int, object>(BuildNumberHiddenField.GetBuildNumbers)),
        ...
        private static object GetBuildNumbers(string buildConfigurationId, int configurerId)
        {
            ...
            if (configurerId == 0)
                ...
                configurer = (Configurer)Util.ExtensionConfigurers.GetExtensionConfigurer(configurerId);
