...
{
    [CustomEditor(typeof(BuildImporterTemplateEditor))]
    internal sealed class BuildImporterTemplate : BuildImporterTemplateBase<BuildImporter>
    {
        [Persistent]
        ...
        public override RichDescription GetDescription()
        {
            ...
            desc.AppendContent($"({this.BuildConfigurationId})");
