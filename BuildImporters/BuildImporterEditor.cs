...
{
    internal sealed class BuildImporterEditor : BuildImporterEditorBase<BuildImporterTemplate>
    {
        private ValidatingTextBox txtArtifactName;
        private ValidatingTextBox txtBranchName;
        private BuildNumberHiddenField ctlBuildNumber;

        public override BuildImporterBase CreateFromForm()
        {
            return new BuildImporter
            {
        ...
        protected override void CreateChildControls()
        {
            ...
            this.ctlBuildNumber = new BuildNumberHiddenField
            {
            ...
            this.Controls.Add(
                new SlimFormField("Build configuration Id:", new Div(this.Template.BuildConfigurationId)),
