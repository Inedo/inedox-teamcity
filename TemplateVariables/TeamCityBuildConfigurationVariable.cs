...
{
    [DisplayName("TeamCity Build Configuration Variable")]
    [Description("Allows selection of a Build Configuration from a TeamCity instance.")]
    [CustomSetter(typeof(TeamCityBuildConfigurationVariableSetter))]
    public sealed class TeamCityBuildConfigurationVariable : VariableBase
    {
        [Persistent]
